...
const from = '0x4cc4c344eba849dc09ac9af4bff1977e44fc1d7e';
...
async function initBancor(accounts) {
    ...
    return {ring: ring, bancorExchange: bancorExchange, bancorConverter: bancorConverter, etherToken: etherToken};
